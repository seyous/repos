...
#line hidden
        ...
        [NUnit.Framework.DescriptionAttribute("login user to create account with valid Email")]
        [NUnit.Framework.CategoryAttribute("mytag")]
        public virtual void LoginUserToCreateAccountWithValidEmail()
        {
            string[] tagsOfScenario = new string[] {
                    "mytag"};
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("login user to create account with valid Email", null, new string[] {
                        "mytag"});
#line 7
...
#line hidden
#line 10
 testRunner.And("create account is displayed", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
#line 11
 testRunner.When("user input their email address", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
#line 12
